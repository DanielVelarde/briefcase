...
\begin{tabular}{ll}
    Dirección: & Achumani, Urb. Estronguista, Calle3 #30, La Paz - Bolivia \\
...
\textbf{Capacitaciones Independientes en Criptoactivos y Desarrollo de Herramientas Predictivas}  
...
\begin{itemize}
    ...
    \item Gracias a mi formación académica en análisis de datos y machine learning, estoy desarrollando una herramienta de análisis predictivo aplicable a todos los mercados financieros, no solo a criptoactivos. Esta herramienta combina análisis técnico, inteligencia artificial y machine learning para proporcionar predicciones precisas y útiles en la toma de decisiones financieras.
    \item El desarrollo de esta herramienta se realiza en Python, y el código fuente está disponible en mi repositorio de GitHub: \url{https://github.com/DanielVelarde/briefcase.git}.
\end{itemize}
...
\begin{itemize}
    ...
    \item Unidad 6: Aplicación de luces en pincel seco y perfilado.
\end{itemize}
