...
if __name__ == "__main__":
    ...
    # Obtener el timestamp de hace un año
    one_year_ago = int((datetime.now() - timedelta(days=365)).timestamp() * 1000)

    # Nombre del archivo consolidado
    consolidated_filename = "cryptos_with_usdt_btc_eth_historical_data.csv"
    ...
    for symbol in active_symbols:
        ...
        historical_data = fetch_historical_data_in_chunks(symbol, "1d", since=one_year_ago)
